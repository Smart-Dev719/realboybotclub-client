...
import mintIntroImg01 from "../../assets/image/tattoo_mint01.jpg";
import mintIntroImg02 from "../../assets/image/tattoo_mint02.jpg";
      ...
      <div className="minttatoos-container d-flex align-items-center justify-content-center">
        <div className="PageMintTattoo align-items-center">
          <div className="MintIntroImg" >
            <img src={mintIntroImg01} alt="mint-intro-img01" />
          </div>
          ...
          <div className="MintMainSection d-flex flex-column justify-content-center align-items-center">
            ...
            >
              ...
              <div className="d-flex flex-column text-white justify-content-center align-items-center price_area MintPricePanel">
                <div>Price</div>
                <div>
                  <span className="fs-30 text-pink totalprice">
                    {totalPrice}
                  </span>{" "}
                  ETH
                </div>
        ...
        <div className="PageMintTattoo align-items-center">
          <div className="MintIntroImg" >
            <img src={mintIntroImg02} alt="mint-intro-img01" />
          </div>
