...
const data = {
  rows: [
    ...
    },
    {
      ...
      content: "At RBBC, we believe there is no other NFT project, doing what we’re doing, we’re giving away more than any other NFT project yet, helping artists build there skills and show their art-work to the world. Artists can leave there mark within our community, and can make money creating and selling their designs."
    }
  ]
};
