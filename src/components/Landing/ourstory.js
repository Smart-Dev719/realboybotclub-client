        ...
        <div className="row pt-5">
            <div className="col-lg-12">
                <div className="row">
                    <div className="col-lg-6 col-cd-12 col-md-6 ourstory_main">
                        ...
                        <div className="mt-4">
                            <motion.div
                                ...
                                transition={{ type: "spring", stiffness: 50 }}
                                viewport={{ once: true, amount: 0 }}
                                className="text-white fs-20 font-origin mt-5"
                            >
                                EARTH 2050…
                                <br />
                    ...
                    <div className="col-lg-5 col-cd-12 col-md-6 d-flex flex-column align-items-end ourstory_img_area">
                        <img
            ...
            <div className="col-lg-12">
                <div className="row">
                    <div className="col-lg-5 col-cd-12 col-md-6 ourstory_main story_2">
                        <img
                    ...
                    <div className="col-lg-6 col-cd-12 col-md-6 d-flex flex-column align-items-end ourstory_img_area">
                        <div className="mt-4">
                            <motion.div
                                ...
                                transition={{ type: "spring", stiffness: 50 }}
                                viewport={{ once: true, amount: 0 }}
                                className="text-white fs-20 font-origin mt-4"
                            >
            ...
            <div className="col-lg-12">
                <div className="row">
                    ...
                    <div className="col-lg-1"></div>
                    <div className="col-lg-5 col-cd-12 col-md-6 d-flex flex-column align-items-end ourstory_img_area story_3">
                        <img
