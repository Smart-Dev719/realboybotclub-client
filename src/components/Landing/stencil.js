    ...
    return (
        <div className="row pt-5">
            <motion.div
                ...
                className="col-lg-4 col-cd-12 col-md-6 d-flex justify-content-end stencil_img_area"
            >
                <img src={stencil_wall} alt="" width="100%" className="test_image" />
            </motion.div>
            <div className="col-lg-8 col-cd-12 col-md-6 mb-5">
                <motion.div
                    initial={{ opacity: 0, y: 50 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ type: "spring", stiffness: 50 }}
                ...
                >
                    <h1>
                        <div className="text-white"><span className="text-white font-bold">THE <br />STENCIL WALL</span></div>
                    </h1>
                </motion.div>
                <div className="mt-4">
                    <motion.div
            ...
            >
                <div className="content_line" id="ourstory"></div>
            </motion.div>
        </div>
    );
};
